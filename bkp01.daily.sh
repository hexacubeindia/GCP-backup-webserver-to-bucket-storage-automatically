...
#
echo " "
echo "Backup to Bucket (daily) process started at $todayfile"
sleep 1
#
#---------------------------------------------------------------------------------------------------------------------------#
#
...
echo " "
gsutil -m cp -r $fpath/$todayfile gs://bkp01.daily.hexacubellc.cf
sleep 1
echo " "
...
echo " "
gsutil du -ch gs://bkp01.daily.hexacubellc.cf/
echo " "
echo " "
echo "Cloud Bucket Backup Overall Disk Usage:"
echo " "
gsutil du -s -h gs://bkp01.daily.hexacubellc.cf
echo " "
echo "**************************************************"
#
##################### SUMMARY ENDS ######################
